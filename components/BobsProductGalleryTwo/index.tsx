...
const BobsProductGalleryTwo = ({ component, page }: BrProps<ContainerItem>): React.ReactElement => {
  const {
    title,
    shopAllLinkText,
    shopAllLinkUrl,
  ...
  return (
    <section className='product-gallery version-two'>
